/* الصيانة — تطبيق: الشبكة أولاً دائماً (البيانات حيّة من القاعدة)، والنسخة المخزّنة للواجهة فقط عند انقطاع النت */
var C = 'afmc-maint-v1';
...
self.addEventListener('fetch', function(e){
  ...
  if (e.request.method !== 'GET' || u.origin !== location.origin || !/maint|housing/.test(u.pathname)) return;
